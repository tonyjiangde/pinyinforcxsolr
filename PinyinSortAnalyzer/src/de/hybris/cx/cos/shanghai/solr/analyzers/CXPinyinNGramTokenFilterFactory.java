...
public class CXPinyinNGramTokenFilterFactory extends TokenFilterFactory {  
    private int minGram;  
    private int maxGram;  
    ...
    public CXPinyinNGramTokenFilterFactory(Map<String, String> args) {  
        super(args);  
    ...
    public TokenFilter create(TokenStream input) {  
        if(edgesNGram) {  
            return new CXPinyinNGramTokenFilter(input, this.minGram, this.maxGram,   
